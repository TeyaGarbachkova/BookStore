...
/****** Object:  Database [BooksDBSQL]    Script Date: 23.4.2017 г. 23:12:18 ч. ******/
CREATE DATABASE [BooksDBSQL]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'BooksDBSQL', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\BooksDBSQL.mdf' , SIZE = 3264KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'BooksDBSQL_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL12.MSSQLSERVER\MSSQL\DATA\BooksDBSQL_log.ldf' , SIZE = 816KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
